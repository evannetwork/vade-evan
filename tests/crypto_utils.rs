...
const VERFICATION_METHOD: &str = "did:evan:testcore:0x0f737d1478ea29df0856169f25ca9129035d6fd1#key-1";
...
fn can_sign_messages() {
  let (signature, message): ([u8; 65], [u8; 32]) = sign_message("hallo", "087d321d9474af5ed4ab1e55c713825b91550f8e491376c768a0d67204f59c49");
